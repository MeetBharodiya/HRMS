...
$pdf->Cell(60,19,$pdf->Image('../assets/images/logo.jpg', 12, 12, 50),'TL',0);
$pdf->Cell(130,10,'Eco Green Solar','TR',1,'L');
$pdf->Cell(60,5,'','L',0,'L' );
$pdf->SetFont('Arial','',12);
$pdf->Cell(130,5,'304, Pragati Complex,','R',1,'L');
$pdf->Cell(60,5,'','L',0,'L' );
$pdf->Cell(130,5,'150 Feet Ring Road,Near Giriraj Hospital,','R',1,'L');
$pdf->Cell(60,5,'','L',0,'L' );
$pdf->Cell(130,5,'Rajkot, Gujarat, India, Pin Code : 360 005,','R',1,'L');
$pdf->SetFont('Arial','B',13);
$pdf->Cell(60,5,'','L',0,'L' );
...
$pdf->Cell(48,10,"IFSC Code: ",'TL',0);
$pdf->Cell(47,10,"".$c['ifsc'],'TR',0);
