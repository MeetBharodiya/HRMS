                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="table1" style="width:100%">
                            ...
                            <?php 
                                 $cnt=1;
                                 $query = "select * from requestforleave,requeststatus where id = requeststatus.approved_id";
                ...
                <div class="card card-1">
                    ...
                    <div class="card-body">
                        <table id="table2" style="width:100%">
                            ...
                            <?php 
                                $cnt=1;
                                $query = "select * from requestforleave,requeststatus where id = requeststatus.rejected_id";
                                $result = mysqli_query($con,$query) or die(mysqli_error($con));
                                while($a = mysqli_fetch_assoc($result)){
                                    $query1 = "select username from userprofile where uid =" .$a['emp_id'];
                                    $result1 = mysqli_query($con,$query1);
